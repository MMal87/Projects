...
message(peep), maker, time, messages, Chitter
```
Verbs:
post a message, see all peeps in reverse chron order, see time of peep, sign up
...
| Peeps                | content, user_id

1. Name of the first table (always plural): `users` 

    Column names: `name`, `password`
...
1. Can one artist have many peeps? YES
2. Can one album have many users? NO
