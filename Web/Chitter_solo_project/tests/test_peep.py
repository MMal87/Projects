...
def test_peep_constructs():
    peep = Peep(1, "Test Title", "Test content", "15:15:15", 1, "John Doe")
    assert peep.id == 1
...
def test_peeps_are_equal():
    peep1 = Peep("1, Test Title", "Test content", "15:15:15", "1", "John Doe")
    peep2 = Peep("1, Test Title", "Test content", "15:15:15", "1", "John Doe")
    assert peep1 == peep2
