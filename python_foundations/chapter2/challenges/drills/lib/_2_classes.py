...
class Cohort():
    def __init__(self, name, start_date, end_date):
        self.name = name
        self.start_date = date.fromisoformat(start_date)#fromisoformat returns the date from a date string
        self.end_date = date.fromisoformat(end_date)

    def calculate_duration(self):
        duration = (self.end_date - self.start_date).days #.days gives the duration as an int when comparing 2 dates
        return duration
